...
render() {
  return (
    <div>
      <Button plain={true} onClick={this.open1.bind(this)}>可自动关闭</Button>
...
render() {
  return (
    <div>
      <Button plain={true} onClick={this.open1.bind(this)}>成功</Button>
...
render() {
  return (
    <div>
      <Button plain={true} onClick={this.open1.bind(this)}>右上角</Button>
      <Button plain={true} onClick={this.open2.bind(this)}>右下角</Button>
      <Button plain={true} onClick={this.open3.bind(this)}>左下角</Button>
      <Button plain={true} onClick={this.open4.bind(this)}>左上角</Button>
    </div>
  )
}
```
