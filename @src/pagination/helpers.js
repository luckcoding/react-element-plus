import { isJson, toNumber, qs } from '@crude/extras';
...
export function pickMidIndex(midIndex, arrSize, showSize) {
  midIndex = toNumber(midIndex, 0);
  arrSize = toNumber(arrSize, 0);
  showSize = toNumber(showSize, 0);
...
function Pages({
  ...
  this.search = isJson(search) ? search : {};
